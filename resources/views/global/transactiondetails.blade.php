...
@section('title', 'Detail Transaksi — Le Petite Pasta')
                ...
                <div class="card mt-0 mb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-6 mx-5 my-3">
                            ...
                            <p class="mt-5"><b>Harga: </b>Rp {{ $transaction->product->price }}</p>
                            <p><b>Jumlah:</b>  {{ $transaction->quantity }}</p>
                            <p><b>Total Harga:</b> Rp {{ ($transaction->product->price)*($transaction->quantity) }}</p>
                        </div>
                    </div>
                </div>
            </div>
