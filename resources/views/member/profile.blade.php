...
@section('title', 'Profil — BungaExpress')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mx-5 my-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <a href="/member/profile/{{ $user->id }}/edit">
                                        <button type="submit" class="btn btn-dark bg-transparent">Edit Profil</button>
                                    </a>
                                </div>

                                <div class="col-md-4 d-flex justify-content-end">
                                    <form action="/member/profile/{{ $user->id }}" method="POST">
                                        @method('delete')
                                        @csrf
